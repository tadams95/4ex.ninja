...
async def root():
    ...
    return {
        ...
        "endpoints": {
            "scan": "/enhanced-daily/scan",
            "signals": "/enhanced-daily/signals", 
            "config": "/enhanced-daily/config",
            "performance": "/enhanced-daily/performance"
        }
    }
...
# Enhanced Daily Strategy Endpoints (Phase 1)
@app.get("/enhanced-daily/scan")
async def enhanced_daily_scan():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, 
            detail=f"Enhanced Daily scan failed: {str(e)}"
        )


@app.get("/enhanced-daily/signals")
async def enhanced_daily_signals():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Enhanced Daily signal generation failed: {str(e)}"
        )


@app.get("/enhanced-daily/performance")
async def enhanced_daily_performance():
    """Get Enhanced Daily Strategy performance metrics."""
    try:
        return {
            "success": True,
            "strategy": "Enhanced Daily Strategy (Phase 1)",
            "performance": enhanced_daily_service.performance_metrics,
...
@app.get("/enhanced-daily/config")
async def enhanced_daily_config():
