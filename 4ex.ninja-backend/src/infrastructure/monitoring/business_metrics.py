...
class BusinessMetricsMonitor:
    ...
    def record_signal_generated(
        ...
        self._signal_metrics.avg_processing_time_ms = (
            current_avg_time * (total_signals - 1) + processing_time_ms
        ) / total_signals
    ...
    def record_user_activity(
        ...
        metric = BusinessMetric(
            ...
            value=1,
            timestamp=time.time(),
            tags={"user_id": user_id, "activity_type": activity_type},
    ...
    def record_cache_operation(
        ...
        metric = BusinessMetric(
            ...
            metadata={"key": key, "processing_time_ms": processing_time_ms},
        )
        self._metrics_history.append(metric)
    ...
    def record_database_operation(
        ...
        metric = BusinessMetric(
            ...
            metadata={"record_count": record_count, "error": error},
        )
        self._metrics_history.append(metric)
    ...
    def get_signal_metrics_summary(self) -> Dict[str, Any]:
        ...
        total_processed = (
            self._signal_metrics.total_validated + self._signal_metrics.total_failed
        )
        ...
        delivery_rate = (
            (
                self._signal_metrics.total_sent
                / self._signal_metrics.total_validated
                * 100
            )
            if self._signal_metrics.total_validated > 0
            else 0
        )
        ...
        return {
            "signal_generation": {
                ...
                "avg_processing_time_ms": round(
                    self._signal_metrics.avg_processing_time_ms, 2
                ),
