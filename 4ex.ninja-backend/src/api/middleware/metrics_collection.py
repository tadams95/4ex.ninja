...
class MetricsCollectionMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        try:
            ...
            await self._record_error_metrics(request, e, processing_time_ms, user_id)
    ...
    async def _record_error_metrics(
        ...
        if performance_monitor:
            performance_monitor.record_timer(
                ...
                duration_ms=processing_time_ms,
                tags={"method": method, "endpoint": url_path, "error_type": error_type},
            )
