          ...
          <div className="max-w-md mx-auto w-full">
            ...
            >
              ...
              <p className="text-gray-400 mb-6">
                Try our full platform for 30 days, then continue for just $9.99/month. Cancel
                anytime during your trial to avoid being charged.
              </p>
        ...
        <div className="space-y-6">
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <p className="text-gray-400">
              After your 30-day free trial, 4ex.ninja costs $9.99 per month. You can cancel anytime
              during your trial to avoid being charged.
            </p>
          </div>

          <div className="bg-gray-800 rounded-lg p-6">
            <h3 className="text-xl font-medium mb-2">
              Do I need to enter payment information for the free trial?
            </h3>
            <p className="text-gray-400">
              Yes, a valid payment method is required to start your free trial, but you won't be
          ...
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <p className="text-gray-400">
              You can cancel your subscription anytime by going to your account settings. If you
              cancel during your trial period, you won't be charged.
            </p>
          </div>
          ...
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <p className="text-gray-400">
              No, 4ex.ninja is a month-to-month subscription with no long-term contracts. You can
              cancel anytime.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 pb-24">
        ...
        <div className="bg-gray-800 rounded-xl p-8">
          ...
          <div className="text-center mt-8">
            <p className="text-gray-400">
              Many competitors charge $50+ per month for similar features. We believe in making
              forex trading tools accessible to everyone.
            </p>
          </div>
        </div>
      </div>
...
// Wrap the component with PricingErrorBoundary
